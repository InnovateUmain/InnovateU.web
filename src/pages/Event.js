...
const Event = () => {
  ...
  <div
    ...
    <div className="md:px-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-4 md:space-y-0">
      <div className="max-w-sm bg-white px-6 pt-6  rounded-xl shadow-lg transform hover:scale-105 transition duration-500 mx-2" style={{height:"520px"}}>
        ...
        <div className="my-4">
          <div className="flex space-x-1 items-center">
            ...
            <p className='navfont text-sm mb-1.5'>15 Jan 2024 | 10.00pm</p>
          </div>
          <div className="flex space-x-1 items-center">
            <span>
            <MdLocationOn className='text-indigo-600 text-2xl mb-1.5'/>
            </span>
            <p className='navfont text-sm'>Arayabhat,Cutm</p>
          </div>
          <div className="flex space-x-1 items-center">
            <span>
            <FaMicrophone className='text-indigo-600 text-2xl mb-1.5'/>
            </span>
            <p className='navfont text-sm'>Mr. Ankit Das</p>
            <p className='text-sm'>(CEO Yellow Ai)</p>
          </div>
