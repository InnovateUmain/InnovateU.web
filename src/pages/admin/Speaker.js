  ...
  const handleChange = (e) => {
   ...
   if(e.target.name=="name"){
    ...
    const exportexcel= async()=>{
        ...
        saveAs(new Blob([buf]), 'SpeakerDetails.xlsx')
       }
                    ...
                    <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            Add a new speaker to the website
...
>
  ...
  <div className="m-2 w-full px-4 lg:px-8 py-4 mx-auto overflow-scroll max-h-[80vh]">
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-lg">
              <h2 className="text-stone-700 text-xl font-bold">
               Update Speaker deatails.
              </h2>
              <p className="mt-1 text-sm">
                Please fill the following details to update the speaker details.
              </p>
              <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div className="flex flex-col">
                  <label
