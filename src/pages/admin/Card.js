...
const Card = () => {
  return (
    ...
    <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div className="px-4 text-gray-700">
            <h3 className="text-sm tracking-wider">Total Applied Members</h3>
    ...
    <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div className="px-4 text-gray-700">
            <h3 className="text-sm tracking-wider">Total Guests</h3>
    ...
    <div className="flex items-center bg-white border rounded-sm overflow-hidden shadow">
        ...
        <div className="px-4 text-gray-700">
            <h3 className="text-sm tracking-wider">Total Devfest Member</h3>
