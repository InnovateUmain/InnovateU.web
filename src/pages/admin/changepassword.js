...
const Changepassword = () => {
    ...
    useEffect(()=>{
const user = JSON.parse(localStorage.getItem("innovateUadmin"));
setUser(user);
    },[])
    ...
    const handleChangePassword=async()=>{
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/admin/updatepassword`, {
          method: "POST", // or 'PUT'
          headers: {
  ...
  <div className="flex flex-col items-center  px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div className="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
          ...
          <div className="mt-4 space-y-4 lg:mt-5 md:space-y-5">
              <div>
                  <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Current Password</label>
              ...
              <div>
                  <label htmlFor="cpassword" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">New Password</label>
