      ...
      {loading?<div className="min-h-screen my-20"><BlogSkeleton/></div>:event&&<section className="py-10 font-poppins bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-blue-700 via-blue-800 to-gray-900 my-20 mx-2 rounded-lg">
              ...
              <div className="lg:pl-20">
                ...
                <div className="p-4 mb-8 border border-gray-300 bg-white rounded-lg">
                  <h2 className="mb-4 text-xl font-semibold dark:text-gray-400">
                    Total Seats{" "}
                    <span className="px-2 bg-blue-500 text-gray-50">{event.eventreglimit}</span>{" "}
                    for this event right now!{" "}
                  </h2>
                  <div className="mb-1 text-xs font-medium text-gray-700 dark:text-gray-400">
                    Hurry up! left {event.eventreglimit=="unlimited"?"unlimited":event.eventreglimit - event.eventregcount}{" "}
                    seats.
                  </div>
        ...
        <VerticalTimeline className="overflow-hidden">
          ...
          >
            ...
            <p>
              Welcome to {event.eventname} ! Get ready to kick off an exciting
          ...
          >
            ...
            <p>
              ...
              for a day filled with insights, connections, and inspiration.
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            ...
            <p>
              ...
              here or if you are seeking more information, feel free to reach
