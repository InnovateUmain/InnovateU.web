    ...
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
        ...
        <div className="text-center">
          <p className="text-xs font-semibold tracking-wide uppercase mb-3 text-gray-200">
            NewsRoom
          </p>
          <h1 className="text-3xl font-bold sm:text-5xl lg:text-6xl lg:leading-tight text-gray-200">
            Subscribe to our{" "}
            <span className="text-blue-500">NewsLater</span>
          </h1>
        </div>
        {/* End Title */}
        {/* Avatar Group */}
        ...
        {/* Form */}
        <form>
          <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3  border rounded-lg shadow-lg shadow-gray-100 bg-slate-900 dark:border-gray-700 dark:shadow-gray-900/[.2]">
            <div className="pb-2 sm:pb-0 sm:flex-[1_0_0%]">
              ...
              <input
                type="text"
                id="hs-hero-name-1"
                className="py-3 px-4 block w-full border-2 border-white rounded-lg text-sm focus:border-blue-5000 bg-slate-900  text-gray-400 focus:ring-gray-600"
            ...
            <div className="pt-2 sm:pt-0 sm:ps-3 border-t border-gray-200 sm:border-t-0 sm:border-s sm:flex-[1_0_0%] dark:border-gray-700">
              ...
              <input
                type="email"
                id="hs-hero-email-1"
                className="py-3 px-4 block w-full  rounded-lg text-sm focus:border-blue-500 border-2 border-white bg-slate-900 border-transparent text-gray-400 focus:ring-gray-600"
                placeholder="Enter Your Email Address"
              />
            </div>
            <div className="pt-2 sm:pt-0 grid sm:block sm:flex-[0_0_auto]">
              <a
                className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-purple-600 text-white hover:bg-purple-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                href="#"
              >
                Subscribe
              </a>
