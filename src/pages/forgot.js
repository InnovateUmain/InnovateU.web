...
const Forgot = () => {
  ...
  return (
    ...
    {loading?<div className='h-[100vh] flex justify-center items-center'><Spinner/></div>:<div className='min-h-screen'>
      <Toaster />
       <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6 py-28">
            <div className="flex-1">
                <div className="text-center">
                    <div className="flex justify-center mx-auto">
                        <img className="" src="https://res.cloudinary.com/dawzncoau/image/upload/v1701193584/InnovateU-removebg-preview_sgnisw.png" alt="Logo" height={100} width={100}/>
                    </div>

                    <p className="mt-3 text-white">Forgot Your Password</p>
                </div>

                <div className="mt-8">
                       {!sendMail&& <div>
                            <label hrmlFor="email" className="block mb-2 text-sm text-white">Email Address</label>
                        ...
                        {otpsent&& <div>
                            <label hrmlFor="email" className="block mb-2 text-sm text-white ">Otp</label>
                      ...
                      {sendMail&& <> <div className="mt-6 relative">
                            <div className="flex justify-between mb-2">
                                <label hrmlFor="password" className="text-sm text-white">Password</label>
                            </div>
                        ...
                        <div className="mt-6 relative">
                            <div className="flex justify-between mb-2">
                                <label hrmlFor="password" className="text-sm text-white">Confirm Password</label>
                            </div>
                        ...
                        {!sendMail&&<div className="mt-6">
                            <button onClick={SendMail} className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform bg-purple-500 rounded-lg hover:bg-purple-600">
                                Send Otp
                            </button>
                        </div>}
                        {sendMail&&<div className="mt-6">
                            <button onClick={handleSubmit} className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-300 transform  bg-purple-500 rounded-lg hover:bg-purple-600">
                                Submit
                            </button>
                        </div>}
